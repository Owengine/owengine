...
class ADMIN_CLASS_MasterPage extends OW_MasterPage
{
    ...
    protected function init()
    {
		...
		// Do you need to add another menu?
        $event = new OW_Event('admin.addMenu', array("menuDataArray"=>$menuDataArray, "menuItems"=>$menuItems),array("menuDataArray"=>$menuDataArray, "menuItems"=>$menuItems));
        OW_EventManager::getInstance()->trigger($event);		
		$data = $event->getData();
		$menuDataArray = $data["menuDataArray"];
		$menuItems = $data["menuItems"];
		//finish method to add more menus
