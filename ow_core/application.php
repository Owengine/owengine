...
class OW_Application
{
    ...
    public function init()
    {
        ...
        $viewRenderer->assignVar('bottomPoweredByLink',
            '<a href="https://www.owengine.com/" target="_blank" title="Powered by OWENGINE CMS"><img src="'.OW_URL_STATIC.'plugins/base/img/powered-by-owengine.png" alt="OWENGINE CMS" /></a>
        ...
        $viewRenderer->assignVar('adminDashboardIframeUrl',
            OW::getRequest()->buildUrlQueryString("//www.owengine.com/spotlight/", $spotParams));
